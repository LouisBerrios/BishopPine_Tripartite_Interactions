...
#kallisto index -i Burkholderia_index.idx cds_from_genomic.fasta
...
kallisto quant --index=Burkholderia_index.idx --output-dir=results/kallisto/${name} -b 100 --threads=4 $FWD $REV
