...
mkdir -p Acidothermus_results/kallisto/
...
kallisto index -i Acidothermus_index.idx acidothermus_cds_genome.fasta
...
kallisto quant --index=Acidothermus_index.idx --output-dir=Acidothermus_results/kallisto/${name} -b 100 --threads=4 $FWD $REV
