...
mkdir -p Streptomyces_results/kallisto/
...
kallisto index -i Streptomyces_index.idx strepto_cds_from_genomic.fna
...
kallisto quant --index=Streptomyces_index.idx --output-dir=Streptomyces_results/kallisto/${name} -b 100 --threads=4 $FWD $REV
