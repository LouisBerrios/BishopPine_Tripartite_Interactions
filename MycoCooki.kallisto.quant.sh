...
mkdir -p MycoCookii_results/kallisto/
...
kallisto index -i MycoCookii_index.idx mycobacteriumcookii.fasta
...
kallisto quant --index=MycoCookii_index.idx --output-dir=MycoCookii_results/kallisto/${name} -b 100 --threads=4 $FWD $REV
